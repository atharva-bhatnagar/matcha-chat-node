...
exports.sendOTP=async(req,res)=>{
  ...
  const { name, email, userType, otp } = req.body;
  ...
  <body style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 30px; color: #333;">
   <div style="text-align: center; margin-bottom: 20px;">
    ...
    <div style="max-width: 600px; margin: auto; background-color: #ffffff; padding: 30px; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.05);">
      ...
      <p><strong>Please verify your email</strong> to complete registration and gain access to your dashboard! Here's your verification code :</p>

      <div style="text-align: center; margin: 30px 0;">
        <p style="text-align: center; font-size: x-large; font-weight: 600; padding: 8px 16px; background-color:aliceblue">${otp}</p>
      </div>
  ...
  <body style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 30px; color: #333;">
   <div style="text-align: center; margin-bottom: 20px;">
    ...
    <div style="max-width: 600px; margin: auto; background-color: #ffffff; padding: 30px; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.05);">
      ...
      <p><strong>Please verify your email</strong> to complete your profile and gain access to top-tier opportunities! Here's your verification code :</p>
...
`
  ...
  if(emailCache.has(idempotencyKey)){
    return res.status(201).json({ message: 'Email already received otp' });
  }
